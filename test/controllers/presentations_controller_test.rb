...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference("Presentation.count") do
      post presentations_url, params: { presentation: { course: @presentation.course, grade: @presentation.grade, title: @presentation.title } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { course: @presentation.course, grade: @presentation.grade, title: @presentation.title } }
